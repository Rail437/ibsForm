...
public class MySimpleMapper {
    ...
    public Message mapToMessage(ReportDto rd){
        Message ms = Message.builder()
                ...
                .field41_1(rd.getTotalWellsBalans().getExploatingFund()).field41_2(rd.getTotalWellsBalans().getOperatingFundTotal()).field41_3(rd.getTotalWellsBalans().getOperatingFundExploit()).field41_4(rd.getTotalWellsBalans().getOperatingFundDowntime()).field41_5(rd.getTotalWellsBalans().getWithoutProductionTotal()).field41_6(rd.getTotalWellsBalans().getWithoutProductionLastYear()).field41_7(rd.getTotalWellsBalans().getAwaitingWellsTime())
                .field42_1(rd.getNewWellsBalans().getExploatingFund()).field42_2(rd.getNewWellsBalans().getOperatingFundTotal()).field42_3(rd.getNewWellsBalans().getOperatingFundExploit()).field42_4(rd.getNewWellsBalans().getOperatingFundDowntime()).field42_5(rd.getNewWellsBalans().getWithoutProductionTotal()).field42_7(rd.getNewWellsBalans().getAwaitingWellsTime())
